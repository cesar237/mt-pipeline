...
int main(int argc, const char **argv) {
    ...
    struct argparse_option options[] = {
        ...
        OPT_INTEGER('p', "priority", &priority, "Base Priority", NULL),
    ...
    GeneratorArgs gen_args = {(Queue **)queues, 3, expe_duration, BATCH_SIZE};
    SinkArgs sink_args = {q4, expe_duration, BATCH_SIZE};
